...
export const NewsIconContainer = styled.div`
width: 9rem;
height: 9rem;
border-radius: 50%;
...
align-items: center;
`;
export const NewsIcon1 = styled(BiCheck)`
color: #333;
font-size: 8rem;
`;

export const NewsIcon2 = styled(BiDetail)`
color: #333;
font-size: 6rem;
`;
export const NewsIcon3 = styled(BiDish)`
color: #333;
font-size: 6rem;
`;
